...
contract MembersV2 is  AccessControlUpgradeable {

    using SafeMathUpgradeable for uint256;
    // using SafeERC20 for IAuditToken;
    ...
    */
    ...
    function modifyName (address member, string memory newName, uint8 userType) public {

        user[member][userType] = newName;
