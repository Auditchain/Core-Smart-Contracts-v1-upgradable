...
contract("ERC20 Auditchain Token", (accounts, deployer) => {
    ...
    describe("Mint", async () => {
        ...
        it('It should mint 1000 tokens by holder1 to holder2. ', async () => {
            ...
            await token.grantRole(MINTER_ROLE, holder1, { from: owner });
        ...
        it('It should not mint tokens by holder1 when authorization is revoked', async () => {
            ...
            await token.grantRole(MINTER_ROLE, holder1, { from: owner });
            await token.revokeRole(MINTER_ROLE, holder1, { from: owner });
        ...
        it('It should not allow to set controller role if the account is not an owner', async () => {

            try {
                await token.grantRole(MINTER_ROLE, holder1, { from: holder2 });
                expectRevert();
